...
<div class="main">
                        ...
                        <div class="input-group" style="margin-top: 23px; ">
                            <div class="form-outline">
                                <form action="searchName.php" method="get" role="form">
                                    <input type="text" name="name" class="form-control" placeholder="Search" size="8"/>
    ...
    <div class="animals_box">
        ...
        WHERE f.Approved='1' and f.food_name LIKE '%$name%'";
        ...
        if($result->num_rows > 0)
        {
            while($food = $result->fetch_assoc())
            {
                ...
                echo "<div class='boxinside' style='height: 560px; margin-right: 20px; margin-left: 80px' >
